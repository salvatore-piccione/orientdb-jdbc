 ...
 *
 */
public class IoTatWorkThread implements Runnable {
    
    private Connection connection;
    
    private static final String ROOT_VERTEX_NAME = "Production Plant";
    
    private static final String NAME = "IoT@Work Device Directory - ";
    
    private static final String CONTAINMENT_RELATION_EDGE = "ontoloc:immediatelyContains";
    ...
    public void run() {
        try {
            ...
            Iterator<Edge> containmentRels = aggregationV.getEdges(Direction.OUT,CONTAINMENT_RELATION_EDGE).iterator();
            Assert.assertTrue(NAME + "There is no edge with label '" + CONTAINMENT_RELATION_EDGE + "' coming from " + v.toString(), containmentRels.hasNext());
